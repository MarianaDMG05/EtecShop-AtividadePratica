...
public class HomeController : Controller
{
    ...
    {
        Produto produto = _context.Produtos.Include(p => p.Categoria).FirstOrDefault(p => p.Id == id);
...
HttpPost]
    ...
    public IActionResult Produto(ProdutoVM produtoAvaliado)
    {
        ...
        {
            Produto produto = _context.Produtos.Include(p => p.Categoria).FirstOrDefault(p => p.Id == produtoAvaliado.Produto.Id);
            var avaliacoes = _context.Avaliacoes.Where(a => a.ProdutoId == produto.Id).ToList();
